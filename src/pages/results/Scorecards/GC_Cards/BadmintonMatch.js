...
export default function BadmintonMatch(props) {
                                            ...
                                            <div className={Styles.body}>
                                                <div className={Styles.eachTeamContainer}>
                                                    ...
                                                    <div className={Styles.teamScore}>
                                                        1st Singles - {val.team1_1s_score}
                                                    </div>
                                                    <div className={Styles.teamScore}>
                                                        1st Doubles - {val.team1_1d_score}
                                                    </div>
                                                    <div className={Styles.teamScore}>
                                                        2nd Singles - {val.team1_2s_score}
                                                    </div>
                                                </div>
                                                ...
                                                <div className={Styles.eachTeamContainer}>
                                                    ...
                                                    <div className={Styles.teamScore}>
                                                        1st Singles - {val.team2_1s_score}
                                                    </div>
                                                    <div className={Styles.teamScore}>
                                                        1st Doubles - {val.team2_1d_score}
                                                    </div>
                                                    <div className={Styles.teamScore}>
                                                        2nd Singles - {val.team2_2s_score}
                                                    </div>
                                                </div>
                                            </div>
