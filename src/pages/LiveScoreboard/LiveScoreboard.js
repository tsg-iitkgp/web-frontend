...
export default function LiveScoreboard() {
  ...
  return (
    <>
      ...
      {heading === "Athletics" && currentTab === "InterIIT" && (
        <Athletics
          show={show}
          data={data}
          heading={heading}
      ...
      {heading === "Badminton" && currentTab === "InterIIT" && (
        <Badminton
          show={show}
          data={data}
          heading={heading}
      ...
      {heading === "Basketball" && currentTab === "InterIIT" && (
        <Basketball
          show={show}
          data={data}
          heading={heading}
      ...
      {heading === "Chess" && currentTab === "InterIIT" && (
        <Chess
          show={show}
          data={data}
          heading={heading}
      ...
      {heading === "Cricket" && currentTab === "InterIIT" && (
        <Cricket
          show={show}
          data={data}
          heading={heading}
      ...
      {heading === "Football" && currentTab === "InterIIT" && (
        <Football
          show={show}
          data={data}
          heading={heading}
      ...
      {heading === "Hockey" && currentTab === "InterIIT" && (
        <Hockey
          show={show}
          data={data}
          heading={heading}
      ...
      {heading === "Squash" && currentTab === "InterIIT" && (
        <Squash
          show={show}
          data={data}
          heading={heading}
      ...
      {heading === "Table Tennis" && currentTab === "InterIIT" && (
        <Tabletennis
          show={show}
          data={data}
          heading={heading}
      ...
      {heading === "Tennis" && currentTab === "InterIIT" && (
        <Tennis
          show={show}
          data={data}
          heading={heading}
      ...
      {heading === "Volleyball" && currentTab === "InterIIT" && (
        <Volleyball
          show={show}
          data={data}
          heading={heading}
      ...
      {heading === "Weight Lifting" && currentTab === "InterIIT" && (
        <Weightlifting
          show={show}
          data={data}
          heading={heading}
      ...
      {heading === "Athletics" && currentTab === "GC" && (
        <AthleticsMatch
          hasBegin={false}
          show={show}
          data={data}
      ...
      {heading === "Badminton" && currentTab === "GC" && (
        <BadmintonMatch
          hasBegin={false}
          show={show}
          data={data}
      ...
      {heading === "Basketball" && currentTab === "GC" && (
        <BasketballMatch
          hasBegin={false}
          show={show}
          data={data}
      ...
      {heading === "Football" && currentTab === "GC" && (
        <FootballMatch
          hasBegin={false}
          show={show}
          data={data}
      ...
      {heading === "Table Tennis" && currentTab === "GC" && (
        <TabletennisMatch
          hasBegin={true}
          show={show}
          data={data}
      ...
      {heading === "Volleyball" && currentTab === "GC" && (
        <VolleyballMatch
          hasBegin={true}
          show={show}
          data={data}
      ...
      {heading === "Weight Lifting" && currentTab === "GC" && (
        <VolleyballMatch
          hasBegin={false}
          show={show}
          data={data}
      ...
      <div className="tabs">
        ...
        >
          <button
            className="btn_interiit"
            id={`${currentTab === "GC" ? "activeTab" : ""}`}
          >
        ...
        >
          <button
            className="btn_interiit"
            id={`${currentTab === "InterIIT" ? "activeTab" : ""}`}
          >
            Inter IIT - SPORTS 2022-23
          </button>
        </div>
      </div>
