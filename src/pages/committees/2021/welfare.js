      ...
      <div className={globalStyles.mainContainer}>
        ...
        <section className={globalStyles.cmtCard1}>
          ...
          <div className={globalStyles.rightCard}>
            <p><br /><br />
              With language, you are at home anywhere<br /> - Edward De Waal<br />
              <br />
              English is the prevailing language of all time. Having a good command of language boosts one's faith and self-esteem. Here is an opportunity for all those who want to surpass the standards of English. English Mentorship Programme in collaboration with ACSESS (Advanced Communication Skills for Engineering and Science Students), a platform Sponsored by Dr Ranbir Sinha, an Alumni of IIT KGP for the welfare of the KGP community, with certification after completion of the course. So hurry up KGPians Do Register before "10th January 2022, 11:59 PM".<br />

              Registration Form:-<button className={globalStyles.btn} ><a href="https://forms.gle/4j92tXSdGT8Lt4Cv6">Click here</a></button><br />
            </p>
          </div>
        </section>
        ...
        <section className={globalStyles.cmtCard1}>
          ...
          <div className={globalStyles.rightCard}>
            <p>
              ...
              Link to submit Project Details:<button className={globalStyles.btn} ><a href="https://forms.gle/71axBULAaZ9DtiKMA">Click here</a></button><br />
            </p>
          </div>
        </section>
        ...
        <section className={globalStyles.cmtCard1}>
          ...
          <div className={globalStyles.rightCard}>
            <p>
              <br />
              <br />
              Induction Program of undergraduate students, 2021 had been conducted from 26th november to 30th november. Find the details below.<br /><br />

              26th November:
              <button className={globalStyles.btn} ><a href=" https://youtu.be/l-7gLRQlxyQ">Forenoon</a></button>&
              <button className={globalStyles.btn} ><a href="https://youtu.be/hp6K-bz9WRI">Afternoon</a></button><br /><br />

              27th November:
              <button className={globalStyles.btn} ><a href=" https://youtu.be/0h8_JwlgTtk">Forenoon</a></button>&
              <button className={globalStyles.btn} ><a href="https://youtu.be/c328-X9G1l0">Afternoon</a></button><br /><br />

              28th November:
              <button className={globalStyles.btn} ><a href=" https://youtu.be/H1sw7gEcLv4">Forenoon</a></button>&
              <button className={globalStyles.btn} ><a href="https://youtu.be/Fj9Zy-luDDM">Afternoon</a></button><br /><br />

              29th November:
              <button className={globalStyles.btn} ><a href="https://youtu.be/GrAJ1hofC94">Forenoon</a></button>&
              <button className={globalStyles.btn} ><a href="https://youtu.be/9GCP6_RGMsw">Afternoon</a></button><br /><br />

              30th November:
              <button className={globalStyles.btn} ><a href=" https://youtu.be/GrAJ1hofC94">Forenoon</a></button>&
              <button className={globalStyles.btn} ><a href="https://youtu.be/aUIjpWC1qEY">Afternoon</a></button><br /><br />

              <button className={globalStyles.btn} ><a href="https://gymkhana.iitkgp.ac.in/files/handbook.pdf">Click here to download Induction program handbook</a></button><br />
        ...
        <section className={globalStyles.cmtCard1}>
          ...
          <div className={globalStyles.rightCard}>
            <p>
              <br /><br />
              "You don't have to control your thoughts. You just have to stop letting them control you."<br /> ~ Dan Millman<br />
              ...
              GoodLives  in association with IIT Kharagpur will be conducting a series of Mental Health awareness workshops. The workshops will be targeting multiple topics of college student's life and their families.
