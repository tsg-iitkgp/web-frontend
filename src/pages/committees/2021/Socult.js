    ...
    <Layout>
      <div className={globalStyles.mainContainer}>
        ...
        <section>
          ...
          <br />
          <h2 style={{ color: 'lightBlue', letterSpacing: '2px' }} >Open IIT Hindi and English Elocution</h2>
          <section>
            ...
            <p className={globalStyles.description}>
              ...
              <br />
              Rules:<br />
              English:<a href="https://docs.google.com/document/d/1SfwNeKQknrynpBWCl7CRlrdVNwa9Z180nj0S-T9j3FU/edit?fbclid=IwAR2FrcM5geO-xN5SYpCU1hg1RlW9Ny0R4kplVOfCxZWcng_RzzLKX0DngpQ">Click here</a><br />
              Hindi:<a href="https://docs.google.com/document/d/1YQcPfEg2hbbt6jd6I5reLa5tV_X3Oe1wlYYVQiIcUtU/edit?fbclid=IwAR33-xj7562A9duEKV6gj9wOIt9-jKqRoLSByIpJteWxPKAyXp4N8zlFWcw">Click here</a><br />
              <br />
              Deadline for registration:28th January 2022
              Deadline for submissions of performances:5th February 2022
              <br />
              Register below:
              English: <a href="https://forms.gle/2snVJTyaPMWRCxAH6">Click here to register</a><br />
              Hindi:<a href="https://forms.gle/VL2xixYYxtfYxiEm9">Click here to register</a><br />
              Make sure you go through the rules.
              We are eagerly waiting to hear you out!!
              <br />

            </p>
          </section>
          <br />
          <h2 style={{ color: 'lightBlue', letterSpacing: '2px' }} >Logo Making Competition</h2>
          <section>
            ...
            <p className={globalStyles.description}>
              ...
              <br />
              Rules:<a href="https://docs.google.com/document/d/12AIW1l83Dv8IgaEfCCfbveXrFDDHShTwQC6S5MTX7mw/edit?fbclid=IwAR3Ftok6rugzm4x0UaY1csoR-3dnIBRWHYUPYJdAlgtfeYC5zyd5ju3KNZI">Click here</a><br />
              Submission Google form:<a href="https://forms.gle/bd6AMwUY3HSp9hEZ8">Click here</a><br />
              <br />
          ...
          <h2 style={{ color: 'lightBlue', letterSpacing: '2px' }} >Mime Competition Result</h2>
          <section>
            <center>
              <div className={globalStyles.imgContainer}>
                <img
          ...
          <section>
            ...
            <p className={globalStyles.description}>
              Are you missing hanging out with friends during a movie night, stuffing yourself with popcorns, and jamming in the fun? Though we are all apart don't worry, as the fun is never meant to be ceased.<br />
          ...
          <h2 style={{ color: 'lightBlue', letterSpacing: '2px' }} >NCA Workshop Flute</h2>
          <section>
            <center>
              <div className={globalStyles.imgContainer}>
                <img
            ...
            <p className={globalStyles.description}>
              " The symbol of art can be seen in the magic of flute"<br />
          ...
          <h2 style={{ color: 'lightBlue', letterSpacing: '2px' }} >Theme photography event</h2>
          <section >
            <center>
