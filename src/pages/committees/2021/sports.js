      ...
      <div className={globalStyles.mainContainer}>
        ...
        <section>
          <center>
            ...
            <div className={globalStyles.img2Container}>
              <img src={sportsquiz} alt="sports quiz" />
            </div>
          </center>
          <br />
          <p className={globalStyles.description}>
            Sports is filled with facts, fantasies, and fun. If you have a knack
            for all sports information around the world and related to IIT Kgp,
            then get ready to put your knowledge to action. IIT KGP Sports
            challenge all the sports brainiacs to “come, quiz, and conquer “
            some brainstorming questions. If you love sports and have an
            affinity for quizzing, do give this a try. Not to mention, you will
            be rewarded with exciting prizes worth fighting for. So, gear up
            with a team of 3 brainiacs and battle out for the best!!
            <br />
            Dates: <br />
            ...
            <br />
            <p style={{ color: "white", textAlign: "left" }}>Quiz Winners:</p>
            <br />
            <img src={quizwin} alt="sports quiz" />
          </p>
        </section>
        ...
        <section>
          ...
          <center>
            ...
            <br />
            <div className={globalStyles.img2Container}>
              <img src={img2} alt="Chess club event" />
            </div>
          </center>
          <br />
          <p className={globalStyles.description}>
            ...
            <br /> The tournament is also open to 2nd-year students who wish to
            join the club. The top performers will also be awarded goodies and
            certificates, so give your ultimate best!
            <br />
            To participate in the tournament, follow the detailed steps given in
            the rulebook below. All rules and regulations related to the
            tournament are available in the same document. Freshers' Tournament
            2021
            <br />
        ...
        <center>
          <h2 style={{ color: "lightBlue", letterSpacing: "2px" }}>
            The Pan IIT Cycling event
          </h2>
        </center>
        <section>
          <center>
            <div className={globalStyles.img2Container}>
              <img src={img1} alt="Cycling event" />
            </div>
          </center>
          <br />
          <p className={globalStyles.description}>
            “Winning means you are willing to go longer, work harder, and give
            ...
            <br />
            All the IITs vied for delivering intense competition.The contest was
            ecstatically embraced by IIT KGP. We fiercely competed for a
